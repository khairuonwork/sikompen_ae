...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (! $schema->hasTable('kompen_respon_hub_imports')) {
            $schema->create('kompen_respon_hub_imports', function (Blueprint $table): void {
                $table->id();
        ...
        if (! $schema->hasTable('kompen_respon_hub_students')) {
            $schema->create('kompen_respon_hub_students', function (Blueprint $table): void {
                $table->id();
        ...
        if (! $schema->hasTable('kompen_respon_hub_details')) {
            $schema->create('kompen_respon_hub_details', function (Blueprint $table): void {
                $table->id();
        ...
        if (! $schema->hasIndex('kompen_respon_hub_details', 'kompen_hub_details_student_date_idx')) {
            $schema->table('kompen_respon_hub_details', function (Blueprint $table): void {
                $table->index(
                    ['kompen_respon_hub_student_id', 'tanggal'],
                    'kompen_hub_details_student_date_idx',
                );
    ...
    /**
     * This repair migration intentionally preserves data already present in the shared database.
     */
